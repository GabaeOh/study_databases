...
(
  ...
  ADDRESS_CODE_ID VARCHAR(50)  NOT NULL COMMENT '유니크 ID',
...
(
  ...
  GENDER_CODE_ID VARCHAR(50) NOT NULL COMMENT '유니크 ID',
...
(
  ...
  PHONE_NUMBERS   VARCHAR(50) NOT NULL COMMENT '전화번호',
  AGE             INTEGER     NOT NULL COMMENT '나이',
  MEMBERS_ID      VARCHAR(50) NOT NULL COMMENT '유니크 ID',
  GENDER_CODE_I   VARCHAR(50) NOT NULL COMMENT '유니크 ID',
  ADDRESS_CODE_ID VARCHAR(50) NOT NULL COMMENT '유니크 ID',
